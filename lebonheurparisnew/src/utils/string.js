...
export function fileSize(length) {
	if ( length < 1024 ) return length + " б";
	if ( length < 1048576 ) return nf(length/1024, 1, ",", " ") + " Кб";
	if ( length < 1073741824 ) return nf(length/1048576, 1, ",", " ") + " Мб";
	else {
		return nf(length/1073741824, 2, ",", " ") + " Гб";
	}
};