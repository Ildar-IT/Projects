...
//const LayoutStatistics = () => import('../components/layouts/layout-statistics.vue');
...
const routes = [
    ...
    },
    {
        ...
        children: [
            ...
            //{ path: '/:hash/review',  name: 'review', component: Review, props: true, meta: { api: 'ReviewValidationController'   } },
            //{ path: '/:hash/review-finish-thanks',  name: 'review-finish', component: ReviewFinish, props: true, meta: {  api: 'ReviewValidationController'  } },
            //{ path: '/:hash/review-finish',  name: 'review-finish2', component: ReviewFinish2, props: true, meta: { api: 'ReviewValidationController'   } },
            {
                path: '/:hash/feedback',
                name: 'feedback',
                component: Feedback,
