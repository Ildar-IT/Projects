    ...
    <div class="settings layout-top">
            ...
            <div v-else class="settings__logo">
                <div class="settings__logo__text">
                    <div class="text-center">
                        <svgicon class="" name="upload" :fill="false" width="32" height="32" color="#00B2BB"/>
                    </div>
                    <div class="text-center">
        ...
        <div class="margin-bottom-main">
            <v-form>
                ...
                <div class="settings__socials margin-bottom-main">
                    <h4 class="margin-bottom-small text-center gray-text">Ссылки для отзывов</h4>

                    <div v-for="(item, index) of reviewLinks" :key="'socials_'+index"
                         class="pt-5 mb-1"
                         :class="isWindowXS?'':'block-max-width'">
                        ...
                        <v-text-field
                                ...
                                hide-details="auto"
                                :prepend-icon="item.icon"
                                v-model="user.UF_REVIEW_LINKS[item.name]"
                        >
                            <template v-slot:prepend>
                                <svgicon :name="item.icon" width="32" height="32" color="#b3b8cb"/>
                            </template>
            ...
            <div class="d-flex justify-center margin-top-small">
                <v-btn :block="isWindowXS" text  class="v-btn--flat v-btn--text v-size--large primary--text ml-0" @click="deleteUserDialog">
                    <svgicon name="trash_full" width="24" height="24" color="#b3b8cb" class="mr-2" />
    ...
    export default {
        ...
        computed: {
            ...
            user() {
                ...
                if (!user.UF_REVIEW_LINKS || typeof user.UF_REVIEW_LINKS !== "object") user.UF_REVIEW_LINKS = {};
