...
const LayoutSuspended = () => import('../components/layouts/layout-suspended.vue');
...
const Qlean = () => import('../components/qlean.vue');
...
const routes = [
	{
		path: '/suspended', component: LayoutSuspended, meta: {},
		children: [
			{
				path: '/',
				name: 'suspended',
	...
	},
	{
		...
		children: [
			...
			{path: '/qlean', name: 'qlean', component: Qlean, meta: {group: 'qlean', api: 'QleanController'}},
			{
				path: '/subscription',
				name: 'subscription',
