    ...
    <div class="pb-8">
      <ol class="ol-lvl1">
        ...
        <ol>
          ...
          <li class="pb-4">
            Настоящая политика Оператора в отношении обработки персональных данных (далее – Политика) применяется ко всей информации, которую Оператор может получить о посетителях веб-сайта  <a href="https://my.qrfb.ru">https://my.qrfb.ru</a> .
          </li>
        </ol>
        <li class="pt-4 pb-4">
        ...
        <ol>
          ...
          <li class="pb-4">
            ...
            сети интернет по сетевому адресу <a href="https://my.qrfb.ru">https://my.qrfb.ru</a>;
          </li>
          <li class="pb-4">
          ...
          <li class="pb-4">
           ...
           <a href="https://my.qrfb.ru">https://my.qrfb.ru</a>;
          </li>
          <li class="pb-4">
            Пользователь – любой посетитель веб-сайта <a href="https://my.qrfb.ru">https://my.qrfb.ru</a>;
          </li>
          <li class="pb-4">
        ...
        <ol>
          <li class="pb-4">
            ...
            через специальные формы, расположенные на сайте <a href="https://my.qrfb.ru">https://my.qrfb.ru</a>.
        ...
        <ol>
          ...
          <li class="pb-4">
           ...
           <li class="pb-4">
             Актуальная версия Политики в свободном доступе расположена в сети Интернет по адресу <a href="https://my.qrfb.ru/privacy">https://my.qrfb.ru/privacy</a>.
          </li>
        </ol>
      </ol>
    </div>
