...
export function api(cmd, options) {
	...
	const pushToken = router.currentRoute.query !== undefined && router.currentRoute.query.pushToken !== undefined ? router.currentRoute.query.pushToken.toString() : false;
	...
	return axios({
		...
		if (response.data.error) {
			...
			if ( response.data.error.code ) throw {message: response.data.error.message, code: response.data.error.code};
